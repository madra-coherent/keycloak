...
import org.keycloak.models.cache.infinispan.SourceReleasingLazyLoader;
...
public class CachedRealm extends AbstractExtendableRevisioned {
    ...
    public CachedRealm(Long revision, RealmModel model) {
        ...
        deviceConfig = new SourceReleasingLazyLoader<>(OAuth2DeviceConfig::new, null);
        cibaConfig = new SourceReleasingLazyLoader<>(CibaConfig::new, null);
        parConfig = new SourceReleasingLazyLoader<>(ParConfig::new, null);
